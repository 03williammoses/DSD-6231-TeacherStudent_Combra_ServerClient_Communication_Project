...
public class LavalServer extends DCMSInterfacePOA  {
	...
	protected LavalServer(String location) throws RemoteException {
		teacherStudentRecords = new HashMap<>();
		List<Record> ar = new ArrayList<>();
		ar.add(new TeacherRecord("LVL1234", "A", "B", "123 C", "1234567890", "CS", "MTL"));
		ar.add(new TeacherRecord("LVL1234", "A", "B", "123 C", "1234567890", "CS", "MTL"));
		teacherStudentRecords.put("A", ar);
		this.location = location;
	}
	protected LavalServer() {
		teacherStudentRecords = new HashMap<>();
		List<Record> ar = new ArrayList<>();
		ar.add(new TeacherRecord("LVL1234", "A", "B", "123 C", "1234567890", "CS", "MTL"));
		ar.add(new TeacherRecord("LVL1234", "A", "B", "123 C", "1234567890", "CS", "MTL"));
	...
	public static Logger logger = Logger.getLogger("Laval");

	public void serverConnection(int port, LavalServer lavalServ) throws RemoteException, AlreadyBoundException {
		addLog("src/main/resources/logs/server/Laval.txt", "Laval");
		...
		while (true) {
			...
			try {
				...
				System.out.println("Service name "+serviceName.length()+" "+serviceName.trim().equalsIgnoreCase("getCount"));
				String outputStr = "";
	...
	public String getRecords(String recordId)
	{
		return recordId;
	}
	...
	synchronized public String getRecordCounts() {
		...
		server3 += this.DatafromOtherServers(8882);
